...
class sesion():
    ...
    def getVersionTaquigrafica(self, file=None):
        ...
        if file != None:
            self.version_taquigrafica = open(file, 'r').read()

            return BeautifulSoup(version_taquigrafica)
            ...
            self.html_version_taquigrafica = BeautifulSoup(version_taquigrafica)
...
if __name__ == '__main__':
    ...
    ss.getVersionTaquigrafica('ejemplos/sesionej1.html')
